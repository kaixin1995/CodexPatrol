...
| `quotas.html` | `js/quotas-page.js` | 额度管理：分页额度卡片、进度条、手动刷新 |
...
| `login.html` | `js/login-page.js` | 登录页 |
| `setup.html` | `js/setup-page.js` | 首次密码设置页 |
...
| `logs/{date}/Ope.log` | 运行时生成 | **否** | 操作日志 |
